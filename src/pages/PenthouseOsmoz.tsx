...
const configurations = [
  ...
  },
  {
    ...
    image: u(`${P}Séjour format réunion 18.jpg`),
  },
  {
...
const galleryItems = [
  ...
  { url: u(`images/Penthouse/Séjour 4.JPG`), label: 'Séjour 4', alt: 'Séjour 4' },
  { url: u(`images/Penthouse/Séjour 5.JPG`), label: 'Séjour 5', alt: 'Séjour 5' },
  { url: u(`images/Penthouse/Séjour 6.JPG`), label: 'Séjour 6', alt: 'Séjour 6' },
  { url: u(`images/Penthouse/Séjour 7.jpg`), label: 'Séjour 7', alt: 'Séjour 7' },
  { url: u(`images/Penthouse/Séjour 8.JPG`), label: 'Séjour 8', alt: 'Séjour 8' },
];
...
const allImages = [
  ...
  { url: u(`images/Penthouse/Séjour 4.JPG`), alt: 'Penthouse Osmoz – Séjour 4' },
  { url: u(`images/Penthouse/Séjour 5.JPG`), alt: 'Penthouse Osmoz – Séjour 5' },
  { url: u(`images/Penthouse/Séjour 6.JPG`), alt: 'Penthouse Osmoz – Séjour 6' },
  { url: u(`images/Penthouse/Séjour 7.jpg`), alt: 'Penthouse Osmoz – Séjour 7' },
  { url: u(`images/Penthouse/Séjour 8.JPG`), alt: 'Penthouse Osmoz – Séjour 8' },
  { url: u(`images/Penthouse/Séjour 9.JPG`), alt: 'Penthouse Osmoz – Séjour 9' },
  { url: u(`images/Penthouse/Séjour 10.JPG`), alt: 'Penthouse Osmoz – Séjour 10' },
  { url: u(`images/Penthouse/Séjour 11.JPG`), alt: 'Penthouse Osmoz – Séjour 11' },
  { url: u(`images/Penthouse/Séjour 11 bis .jpg`), alt: 'Penthouse Osmoz – Séjour 11 bis' },
  { url: u(`images/Penthouse/Séjour 12.JPG`), alt: 'Penthouse Osmoz – Séjour 12' },
  { url: u(`images/Penthouse/Séjour 13.jpg`), alt: 'Penthouse Osmoz – Séjour 13' },
  { url: u(`images/Penthouse/Séjour 14.JPG`), alt: 'Penthouse Osmoz – Séjour 14' },
  { url: u(`images/Penthouse/Séjour 15.jpg`), alt: 'Penthouse Osmoz – Séjour 15' },
  { url: u(`images/Penthouse/Séjour 16.JPG`), alt: 'Penthouse Osmoz – Séjour 16' },
  { url: u(`images/Penthouse/Séjour 17.jpg`), alt: 'Penthouse Osmoz – Séjour 17' },
  { url: u(`images/Penthouse/Séjour format réunion 18.jpg`), alt: 'Penthouse Osmoz – Séjour format réunion 18' },
  { url: u(`images/Penthouse/Séjour format réunion 18 bis.jpg`), alt: 'Penthouse Osmoz – Séjour format réunion 18 bis' },
  { url: u(`images/Penthouse/Séjour format conférence 19.jpg`), alt: 'Penthouse Osmoz – Séjour format conférence 19' },
  { url: u(`images/Penthouse/Séjour format conférence 19 bis.jpg`), alt: 'Penthouse Osmoz – Séjour format conférence 19 bis' },
  { url: u(`images/Penthouse/Séjour 20.jpg`), alt: 'Penthouse Osmoz – Séjour 20' },
