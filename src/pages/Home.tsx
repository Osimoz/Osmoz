      ...
      <section className="pt-32 pb-16 sm:pt-40 sm:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 aspect-[16/9] rounded-xl overflow-hidden">
            <img 
              src="/src/assets/images/19_DSC4632-HDR.jpg"
            ...
            {[
              {
                ...
                image: "/src/assets/images/1_DSC4725-HDR OK.jpg"
              },
              {
                ...
                image: "/src/assets/images/3_DSC4743-HDR.jpg"
              },
              {
                ...
                image: "/src/assets/images/22_DSC4641-HDR.jpg"
              }
            ].map((space, index) => (
              <div 
                key={index}
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-lg font-light mb-2">{space.title}</h3>
